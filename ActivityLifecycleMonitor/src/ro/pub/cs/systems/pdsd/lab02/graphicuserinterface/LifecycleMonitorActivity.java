...
public class LifecycleMonitorActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null)
			...
			Log.d(Constants.TAG, "There is an activity to restore");
	}
	...
	protected void onSaveInstanceState(Bundle savedInstanceState) {
		...
		boolean checkbox_checked = rememberMeCheckbox.isChecked();
		if (checkbox_checked) {
			savedInstanceState.putString(Constants.USERNAME_EDIT_TEXT,
					usernameEditText.getText().toString());
			savedInstanceState.putString(Constants.PASSWORD_EDIT_TEXT,
					passwordEditText.getText().toString());
			savedInstanceState.putBoolean(Constants.REMEMBER_ME_CHECKBOX,
					checkbox_checked);
		}
	}
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		if (savedInstanceState.getBoolean(Constants.REMEMBER_ME_CHECKBOX) == true) {
